...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->TON0.,IN,,__GET_VAR(data__->LOCALVAR0,));
  __SET_VAR(data__->TON0.,PT,,__time_to_timespec(1, 0, 10, 0, 0, 0));
  TON_body__(&data__->TON0);
  __SET_VAR(data__->,LOCALVAR1,,__GET_VAR(data__->TON0.Q,));
  __SET_VAR(data__->TON1.,IN,,__GET_VAR(data__->LOCALVAR1,));
  __SET_VAR(data__->TON1.,PT,,__time_to_timespec(1, 0, 5, 0, 0, 0));
  TON_body__(&data__->TON1);
  __SET_VAR(data__->,LOCALVAR2,,__GET_VAR(data__->TON1.Q,));
  __SET_VAR(data__->TON2.,IN,,__GET_VAR(data__->LOCALVAR2,));
  __SET_VAR(data__->TON2.,PT,,__time_to_timespec(1, 0, 3, 0, 0, 0));
  TON_body__(&data__->TON2);
  __SET_VAR(data__->,LOCALVAR3,,__GET_VAR(data__->TON2.Q,));
